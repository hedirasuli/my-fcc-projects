...
window.InvalidUserInputError = InvalidUserInputError;
...
function renderCard() {
    ...
    if (cardQuestionEl)
        cardQuestionEl.textContent = activeCard.questionText;
    if (cardAnswerEl)
        cardAnswerEl.textContent = activeCard.questionAnswer;
}
